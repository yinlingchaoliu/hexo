...
- 日常问题锦集
---
脚本的核心就是一句话，用gradle脚本方式写的
```
>javain\java -jar jiagu.jar -jiagu <inputAPKpath> <outputpath> -autosign - automulpkg
```

先单独执行这句话，找打印日志的`执行命令行`
```
...
注意点：
1、360加固登录账号密码要设置上，勾选自动登录
2、签名要在加固宝中配置好
3、加固时间长，需要联网，加固过程中需要1~2分钟等待
